class Capseur {
  ...
  Capseur(
      ...
      this._capsHit,
      this._capsThrow,
      this._bottlesEmptied,
      this._uid,
      this._points,
      this._victorySerieActual,
      this._victorySerieMax,
      this._maxReverse);
  ...
  int get ratio =>
      (this.capsThrow != 0) ? (this.capsHit / this.capsThrow * 100).round() : 0;

  double get bottlesEmptied => _bottlesEmptied;
  String get uid => _uid;
