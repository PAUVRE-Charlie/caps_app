          ...
          SingleChildScrollView(
            child: Column(
              children: [
                ...
                TextRules(
                    Platform.isIOS
                        ? "Each player place a bottle between his legs and place the cap upside down on the top of the bottle."
                ...
                TextRules(
                  Platform.isIOS
                      ? "You are able to choose the number of points per bottle and number of bottles in a match, usually you'll play in 12 or 16 points with 4 points per bottle (so 3 or 4 bottles). After it's up to you to play with other configurations."
